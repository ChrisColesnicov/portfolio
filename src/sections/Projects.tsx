      ...
      <div className="container">
        ...
        <div className="flex flex-col mt-10 md:mt-20 gap-12">
          {portfolioProjects.map((project) => (
            <div
              key={project.title}
              className="bg-gray-800 rounded-3xl relative z-0 after:z-10 overflow-hidden after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 md:px-10 pt-8 md:pt-12 after:pointer-events-none flex flex-col justify-between min-h-[20rem] md:min-h-[25rem]"
            >
              <div
              ...
              <Image
                src={project.image}
                alt={project.title}
                className="mt-8 -mb-4 rounded-lg object-cover object-top h-48 md:h-96 w-full md:-mb-0 "
              />
            </div>
          ))}
        </div>
